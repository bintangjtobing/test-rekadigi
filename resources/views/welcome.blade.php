...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Test Laravel | Rekadigi</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<div class="position-absolute vh-100 vw-100 top-0 start-0 overflow-hidden">
			<img src="images/hero-bg.svg" alt="" class="hero-bg">
		</div>
				...
				<div class="container">
					<div class="header-row">
						...
						<div id="logo" class="me-lg-5">
							<a href="#" ><img src="images/logo.svg" alt=" Logo" class="py-3"></a>
						</div><!-- #logo end -->
						...
						<div class="header-misc">
							...
							<!-- Top Search
							============================================= -->
							<a href="#" class="button bg-white rounded-pill text-dark h-shadow-sm box-shadow">Create a Project <i class="bi-arrow-right me-0 ms-1"></i></a>
						...
						<nav class="primary-menu me-lg-auto">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="#"><div>Beranda</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Tentang GAS</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Fitur</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Daftar</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Karir</div></a></li>
							</ul>
			...
			<div class="content-wrap overflow-visible pb-0">
				...
				<div class="position-relative">
							...
							<div class="row col-mb-50">
								<div class="col-lg-5">
                                    ...
                                    <div class="d-flex align-items-center mt-5">
                                        <img src="images/avatar.svg" alt="User" width="54">
                                        <div class="ms-3">
                                ...
                                <div class="col-lg-7">
                                    <img src="images/browser.jpg" alt="Image" class="shadow-lg rounded-6" width="720">
                                    <img src="images/hero-iphone.png" alt="Image" width="150" class="position-absolute mt-5 d-block d-lg-none" style="right: 0; bottom: 0;">
                                </div>
							</div>
						</div>
					</div>
					...
					<div class="section-2 mt-5 mt-lg-0">
						<div class="container p-4 p-sm-5 p-md-6 rounded-6" style="background: linear-gradient( to bottom left, rgba(255, 224, 54, .3), rgba(216, 220, 232, .5) 70% );">
							<div class="row">
								<div class="col-lg-6">
                                    <h1 class="display-5 fw-bold lh-base mb-5">Trusted by 250+ <span class="circle-draw"><span>Companies</span><svg xmlns="http://www.w3.org/2000/svg" width="510" height="119" viewBox="0 0 510 119.584"><path d="M98.269,102.723c191.518,50.4,433.149-14.254,403.627-69.23C469.212-.827,218,3,94,25.5S-30.549,100.9,109.5,115c138.587,5.83,313.427-3.644,362.5-34.5,30.5-19.177,82.988-57.915-47-74.937" transform="translate(-0.645 -3.32)" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-width="4"></svg></span>.</h1>
						...
						<div class="section-sticky">
							<div class="container">
								<div class="row justify-content-end">
									<div class="col-md-7">
										<div class="position-relative">
											<img src="images/browser.jpg" alt="Image" class="position-relative op-0">
                                            <img src="images/hero-iphone-2.png" alt="Image" width="220" class="parallax position-absolute mb-5" style="right: 0; bottom: -50px; opacity: 0;" data-200-start="transform: translate(0px, 0px); opacity: 0;" data-top-bottom="transform: translate(-260px, -60px); opacity: 1;">
                                            <img src="images/hero-iphone.png" alt="Image" width="220" class="parallax position-absolute mb-5" style="right: 0; bottom: -60px;" data-0="transform: translate(0px, 0px) scale(1); bottom: -60px;" data-top-bottom="transform: translate(-60px, 60px) scale(1.3); bottom: 63px;">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container py-lg-6 mw-md mt-5">
					...
					<div class="text-center mb-lg-6">
						<h2 class="mb-1 display-6 fw-bold">All the <span class="circle-draw"><span>features</span><svg xmlns="http://www.w3.org/2000/svg" width="510" height="119" viewBox="0 0 510 119"><path d="M98.269,102.723c191.518,50.4,433.149-14.254,403.627-69.23C469.212-.827,218,3,94,25.5S-30.549,100.9,109.5,115c138.587,5.83,313.427-3.644,362.5-34.5,30.5-19.177,82.988-57.915-47-74.937" transform="translate(-0.645 -3.32)" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-width="4"></svg></span> you want</h2>
						...
						<div class="row gutter-custom justify-content-center" style="--custom-gutter: 80px;">
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="images/services/3.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="images/services/2.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="images/services/1.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="images/services/4.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
				...
				<div class="section sticky-top p-0 mb-0" style="overflow: visible;">
					<div class="row g-0">
						<div class="col-md-6 position-sticky m-0 vh-40 min-vh-md-100 top-0 z-1 overflow-hidden">
							<!-- Sticky Image Target -->
							<div id="list-example" class="w-100 h-100" style="background: url('images/sticky-section/video-poster.jpg') no-repeat center center / cover;">
								<!-- List Item 1 -->
								<a class="list-group-item active" href="#list-item-1">
									<div class="video-wrap no-placeholder">
										<video id="slide-video" poster="images/sticky-section/video-poster.jpg" preload="auto" loop autoplay muted playsinline>
											<source src='images/sticky-section/video.mp4' type='video/mp4'>
										</video>
									</div>
								</a>
									...
									<div class="fslider position-absolute h-100 w-100 top-0 start-0" data-loop="true" data-pause="5000" data-animation="fade">
										<div class="flexslider h-100">
											<div class="slider-wrap">
												<div class="slide" style="background: url('images/sticky-section/2-1.jpg') center right; background-size: cover; height: 100% !important;"></div>
												<div class="slide" style="background: url('images/sticky-section/2-2.jpg') center right; background-size: cover; height: 100% !important;"></div>
											</div>
										</div>
									</div>
									<i class="bi-play-fill icon-stacked transform-ts bg-white h-bg-light rounded-circle text-dark h1 text-center ps-1 shadow z-9"></i>
								</a>

								<!-- List Item 3 -->
								<a class="list-group-item" href="#list-item-3" style="background-image: url('images/sticky-section/3.jpg');">
									<i class="bi-play-fill icon-stacked transform-ts bg-white h-bg-light rounded-circle text-dark h1 text-center ps-1 shadow"></i>
								</a>

								<!-- List Item 4 -->
								<a class="list-group-item" href="#list-item-4"  style="background-image: url('images/sticky-section/1.jpg');">
									<i class="bi-play-fill icon-stacked transform-ts bg-white h-bg-light rounded-circle text-dark h1 text-center ps-1 shadow"></i>
								</a>
							</div>
						</div>
						...
						<!-- List Item Content -->
						<div class="col-md-6 list-group-content" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="250">
							<!-- List Item Content 1 -->
				...
				<div class="section my-0 bg-transparent">
					<div class="container py-lg-5">
						...
						<div class="row justify-content-center gy-5" style="--bs-gutter-x: 60px">
							<div class="col-xl-5 col-lg-6">
								<div class="card border-0 bg-color rounded-6 pt-0">
									<div class="card-body text-center p-5 pt-0">
										...
										<div class="bg-white p-2 d-flex justify-content-center align-items-center rounded text-start">
										...
										<div class="text-start my-5 d-flex flex-column justify-content-center align-items-center text-start">
											<div>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> Use free 30 Days with pay</h4>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> Use it from anywhere</h4>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> All devices except mobile</h4>
												<h4 class="h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> For individual person only</h4>
											</div>
										</div>
										<a href="#" class="button button-xlarge bg-white text-dark px-5 py-3 w-100 rounded-pill h-op-09 m-0" style=" white-space: normal;">Start your 30-Day Free Trial</a>
							...
							<div class="col-xl-5 col-lg-6">
								<div class="card border-0 rounded-6 pt-0" style="background: linear-gradient( to bottom left, rgba(255, 224, 54, .3), rgba(216, 220, 232, .5) 70% );">
									<div class="card-body text-center p-5 pt-0">
										...
										<div class="bg-white p-3 d-flex justify-content-center align-items-center rounded text-start">
										...
										<div class="text-start my-5 py-3 d-flex flex-column justify-content-center align-items-center text-start">
											<div>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill text-dark me-2"></i> Use it from anywhere</h4>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill text-dark me-2"></i> For all latest devices</h4>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill text-dark me-2"></i> Unlimited users excess</h4>
												<h4 class="h6 fw-medium"><i class="bi-check-circle-fill text-dark me-2"></i> Priority support available</h4>
											</div>
										</div>
										<a href="#" class="button button-xlarge button-dark h-bg-dark px-5 py-3 w-100 rounded-pill h-op-09 m-0">Contact Us</a>
				...
				<div class="section bg-color bg-opacity-10 py-0 mt-lg-4 mt-0">
					<div class="position-absolute top-0 end-0 w-100 h-100" style="background: url('images/section-bg.svg') no-repeat right 70%; background-size: 100%;"></div>
					<div class="container">
								...
								<div class="d-flex mt-4">
									<div class="d-flex flex-column me-2">
										<a href="#" class="button button-xlarge rounded-pill button-dark d-flex align-items-center justify-content-center py-3 bg-dark h-op-09 m-0 mb-3">
											...
											<img src="images/appstore.svg" alt="Store Logo" width="45" height="45">
										...
										<a href="#" class="button button-xlarge rounded-pill button-dark d-flex align-items-center justify-content-center py-3 bg-dark h-op-09 m-0">
											<img src="images/playstore.svg" alt="Store Logo" width="45" height="45">
											<div class="d-flex flex-column ms-3">
												<small class="fw-normal text-smaller lh-1 mb-2 op-06">Get it on the</small>
									...
									<img src="images/qr.svg" alt="Image" height="170" class="bg-white border p-2 ms-4">
								</div>
							</div>

							<div class="col-lg-6 col-md-8 mt-6 mt-sm-0">
								<div class="d-flex align-items-end">
									<img src="images/phone-2-half.png" class="fast" alt="Image" style="width: 300px;">
									<img src="images/phone-1-half.png" class="fast" alt="Image" style="width: 370px; transform: translateX(-100px);">
								</div>
							</div>
					...
					<div class="row col-mb-50">
						...
						<div class="col-md-4">
							<div class="widget">
								...
								<div>
									<a href="#" class="social-icon border-color h-border-transparent h-bg-facebook">
										<i class="fa-brands fa-facebook-f"></i>
										<i class="fa-brands fa-facebook-f"></i>
									</a>

									<a href="#" class="social-icon border-color h-border-transparent h-bg-delicious">
										<i class="fa-brands fa-delicious"></i>
										<i class="fa-brands fa-delicious"></i>
									</a>

									<a href="#" class="social-icon border-color h-border-transparent h-bg-paypal">
						...
						<div class="col-md-2">
							<div class="widget">
								...
								<div id="gotoTop" class="bi bi-arrow-up bg-white box-shadow h-shadow-sm text-dark rounded-circle all-ts"></div>

								<p class="mb-0 mt-4 mt-md-5 text-smaller op-06">Copyrights &copy; 2023 All Rights Reserved by  Inc.</p>
